...
function printOrder(o) {
  ...
  <div class="totals">
    ...
    ${o.productDiscount > 0 ? `<div style="color:#34C759"><span>Product Discount</span><span>- Rs. ${o.productDiscount?.toLocaleString()}</span></div>` : ''}
                        ...
                        <div style={s.itemsBox}>
                          ...
                          <div style={s.orderSummary}>
                            ...
                            <div style={s.summaryRight}>
                              ...
                              {o.productDiscount > 0 && <div style={{ ...s.summaryRow, color: '#34C759' }}><span>Product Discount</span><span>− Rs. {o.productDiscount?.toLocaleString()}</span></div>}
